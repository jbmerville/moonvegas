...
import ChoicesSection from '@/components/pages/coinflip/ChoicesSection';
import CoinFlipInfoCardsSection from '@/components/pages/coinflip/CoinFlipInfoCardsSection';
